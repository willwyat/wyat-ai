    ...
    <div className="min-h-screen bg-background text-foreground p-6 pb-20 md:pb-6">
      <div className="max-w-6xl mx-auto">
        <header className="text-center mb-12">
          <h1 className="text-5xl font-bold mb-4 font-serif text-gray-900 dark:text-white">
            Wyat AI
          </h1>
              ...
              <nav className="space-y-3">
                {section.links.map((link, linkIndex) => (
                  <Link
                    key={linkIndex}
                    href={link.href}
                    className="block p-3 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors group"
                  >
